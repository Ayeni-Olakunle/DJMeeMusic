    ...
    <section>
      ...
      {count === 1 ? (
        <div className={style.fade}>
          <div className={style.holdText}>
            ...
            <p>
              Unleash the power of "MeeMusic" and experience a party like never
              before! Our cutting-edge DJ services will take control of the
              beats, transforming your event into an electrifying celebration
              that transcends all expectations. Get ready to elevate your party
              to a whole new level as our expert DJs curate an unforgettable
              playlist, perfectly tailored to your taste and vibe.
            </p>
            <div className={style.holdButton}>
              <button className={style.HireMe}>Hire Me</button>
              <button className={style.bookNow}>Book Now</button>
        ...
        <div className={style.fade}>
          <div className={style.holdText}>
            ...
            <p>
              ...
              "I'mNotUrRegularDj" to take you on a ride through euphoria, where
              the night comes alive with a symphony of emotions and melodies.
            </p>
            <div className={style.holdButton}>
              <button className={style.HireMe}>Hire Me</button>
              <button className={style.bookNow}>Book Now</button>
      ...
      {/* {count === 4 ? (
        <div className={style.slide}>
          <div className={style.holdText}>
            <h1>
              "Dive into a world of euphoria where music and emotions collide."
              6."Join the ultimate sonic
              <br />
              revolution and let the DJ guide you to the dancefloor of your
              dreams.
            </h1>
            <p>
              With pulsating beats and infectious rhythms, we'll transport you
